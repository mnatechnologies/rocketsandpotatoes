                ...
                <div key={item.name} className="relative">
                  {item.dropdown ? (
                    <button
                      ...
                      className={`flex items-center gap-1 px-4 py-2 text-foreground hover:text-primary transition-colors duration-200 font-semibold rounded-md hover:bg-muted/50 ${
                    ...
                    <Link
                      href={item.href}
                      className="px-4 py-2 text-foreground hover:text-primary transition-colors duration-200 font-semibold rounded-md hover:bg-muted/50"
                    >
                      {item.name}
                    </Link>
                  )}
